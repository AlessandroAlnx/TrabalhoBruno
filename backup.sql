...
-- Sequences
CREATE SEQUENCE public.ususarios_id_login_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
CREATE SEQUENCE public.codigos_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
CREATE SEQUENCE public.analises_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
SET DEFAULT nextval('public.ususarios_id_login_seq'::regclass);
ALTER TABLE ONLY public.codigos
ALTER COLUMN id_codigo
SET DEFAULT nextval('public.codigos_id_seq'::regclass);
ALTER TABLE ONLY public.analises
ALTER COLUMN id
SET DEFAULT nextval('public.analises_id_seq'::regclass);
ALTER TABLE ONLY public.logs
ALTER COLUMN id
SET DEFAULT nextval('public.logs_id_seq'::regclass);
-- Sequence values
